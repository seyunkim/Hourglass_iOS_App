...
// Check if the user that send in the event is a live user or one of the admin team
// Required
//// N/A
function isLiveUser(request) {
  if (request.params.userName == "lPpvRJR5hc" || request.params.userName == "8JTwT7acAJ" || request.params.userName == "kpUX4HBHCx") {
    return false;
  } else {
    return true;
  }
